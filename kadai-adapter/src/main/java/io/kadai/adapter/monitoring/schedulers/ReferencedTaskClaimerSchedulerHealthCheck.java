...
@Component("referencedTaskClaimerSchedulerHealthCheck")
public class ReferencedTaskClaimerSchedulerHealthCheck implements HealthIndicator {

  private final LastSchedulerRun lastSchedulerRun;

  public ReferencedTaskClaimerSchedulerHealthCheck(
      @Qualifier("referencedTaskClaimerLastRun") LastSchedulerRun lastSchedulerRun) {
