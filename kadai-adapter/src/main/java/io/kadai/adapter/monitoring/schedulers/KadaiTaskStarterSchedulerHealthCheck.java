...
@Component("kadaiTaskStarterSchedulerHealthCheck")
public class KadaiTaskStarterSchedulerHealthCheck implements HealthIndicator {

  private final LastSchedulerRun lastSchedulerRun;

  public KadaiTaskStarterSchedulerHealthCheck(
