...
@Component("referencedTaskClaimCancelerSchedulerHealthCheck")
public class ReferencedTaskClaimCancelerSchedulerHealthCheck implements HealthIndicator {

  private final LastSchedulerRun lastSchedulerRun;

  public ReferencedTaskClaimCancelerSchedulerHealthCheck(
      @Qualifier("referencedTaskClaimCancelerLastRun") LastSchedulerRun lastSchedulerRun) {
