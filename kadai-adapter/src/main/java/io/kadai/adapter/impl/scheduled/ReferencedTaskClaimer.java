...
@Component
public class ReferencedTaskClaimer implements MonitoredScheduledComponent {
  ...
  public ReferencedTaskClaimer(
    ...
    this.runIntervalMillis = adapterConfiguration.getScheduler().getClaimReferencedTasksInterval();
  }

  @Transactional
  @Scheduled(fixedRateString = "#{adapterConfiguration.scheduler.claimReferencedTasksInterval}")
