...
@Component
public class Camunda7TaskEventErrorHandler {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(Camunda7TaskEventErrorHandler.class);
  private final HttpHeaderProvider httpHeaderProvider;
  private final RestClient restClient;

  public Camunda7TaskEventErrorHandler(
