...
public class Camunda7TaskEventListResource implements Serializable {
  ...
  public Camunda7TaskEventListResource(Camunda7TaskEventList camunda7TaskEventList) {
    this.camunda7TaskEvents = camunda7TaskEventList.getCamunda7TaskEvents();
  }

  public List<Camunda7TaskEvent> getCamunda7TaskEvents() {
    return camunda7TaskEvents;
  }

  public void setCamunda7TaskEvents(List<Camunda7TaskEvent> camunda7TaskEvents) {
    this.camunda7TaskEvents = camunda7TaskEvents;
  }
}
