...
public class Camunda7ListenerConfiguration {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(Camunda7ListenerConfiguration.class);
  private final Properties outboxProperties = new Properties();

  private Camunda7ListenerConfiguration() {
  ...
  public static Camunda7ListenerConfiguration getInstance() {
    return Camunda7ListenerConfiguration.LazyHolder.INSTANCE;
  }
  ...
  private static class LazyHolder {
    private static final Camunda7ListenerConfiguration INSTANCE =
        new Camunda7ListenerConfiguration();
  }
}
