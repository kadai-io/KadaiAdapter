...
class Camunda7OutboxExampleIntegrationTest {
  ...
  void setUp() {
    ...
    configuration.setJdbcUrl("jdbc:h2:mem:camunda-outbox-example;DB_CLOSE_DELAY=-1");
    ...
    deployment.addClasspathResource("simple_user_task_process.bpmn");
    deployment.deploy();
  }
  ...
  @Test
  void should_PersistCreateEvent_When_OutboxExampleProcessStarts() throws Exception {
  ...
  private DataSource createDataSource() {
    ...
    dataSource.setURL("jdbc:h2:mem:camunda-outbox-example;DB_CLOSE_DELAY=-1");
