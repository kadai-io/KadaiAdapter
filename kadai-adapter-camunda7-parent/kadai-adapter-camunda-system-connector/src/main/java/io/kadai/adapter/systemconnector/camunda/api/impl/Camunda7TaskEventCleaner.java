 ...
 */
@Component
public class Camunda7TaskEventCleaner {

  private static final Logger LOGGER = LoggerFactory.getLogger(Camunda7TaskEventCleaner.class);
  private final HttpHeaderProvider httpHeaderProvider;
  private final RestClient restClient;

  public Camunda7TaskEventCleaner(HttpHeaderProvider httpHeaderProvider, RestClient restClient) {
  ...
  private void deleteCamunda7TaskEventsFromOutbox(
