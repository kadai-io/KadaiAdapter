...
public class SystemConnectorCamunda8ProviderImpl implements OutboundSystemConnectorProvider {
  ...
  public List<OutboundSystemConnector> create() {
    ...
    final Camunda8TaskClaimer taskClaimer =
        AdapterSpringContextProvider.getBean(Camunda8TaskClaimer.class);
    final Camunda8TaskCompleter taskCompleter =
        AdapterSpringContextProvider.getBean(Camunda8TaskCompleter.class);
    final Camunda8TaskClaimCanceler taskClaimCanceler =
