...
class SchedulerHealthCheckTest extends AbsIntegrationTest {
  ...
  static class TestConfig {
    ...
    SchedulerHealthCheck schedulerHealthCheck() {
      ...
      HealthIndicator starter =
          spy(new SchedulerHealthIndicator(starterLastRun, "Kadai Task Starter"));
      HealthIndicator terminator =
          spy(new SchedulerHealthIndicator(terminatorLastRun, "Kadai Task Terminator"));
      HealthIndicator claimer =
          spy(new SchedulerHealthIndicator(claimerLastRun, "Referenced Task Claimer"));
      HealthIndicator completer =
          spy(new SchedulerHealthIndicator(completerLastRun, "Referenced Task Completer"));
      HealthIndicator canceler =
          spy(new SchedulerHealthIndicator(cancelerLastRun, "Referenced Task Claim Canceler"));
  ...
  void should_ReturnUp_When_SchedulerRuns(String name) {
    ...
    HealthIndicator indicator = new SchedulerHealthIndicator(mockRun, name);
